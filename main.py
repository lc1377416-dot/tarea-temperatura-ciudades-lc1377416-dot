...
temperatura_minima=temperatura_minima["Phoenix"].min()
...
print("El día con la temperatura máxima en Phoenix fue:", fecha_max )
...
temperatura_promedio=temperatura_promedio.round(2)
